...
class Job:
    ...
    def get_param_name(self,
        ...
        param_nums = [int(p.name.split('_')[-1])
                      for p in self.runs_path.glob('param*')] or [0]
        ...
        for param_p in self.runs_path.glob('param_*'):
            ...
            new_param_num = max(param_nums) + 1
    ...
    def calc_num_needed(self,
        ...
        num_times_logged = num_times_logged if not unittest else 0
    ...
    def update_job_name(self,
        ...
        self.param2val['save_path'] = save_path
