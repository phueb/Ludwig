...
src works on dictionaries and any custom class would force potentially unwanted logic on user.
...
keep interface between user and src as simple as possible
"""
